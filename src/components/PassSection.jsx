...
const PassSection = ({ email }) => {
  ...
  return (
      <div className="relative overflow-hidden w-full max-w-[900px] mx-auto bg-white rounded-3xl shadow-sm p-6 sm:p-8 md:p-12 flex flex-col md:flex-row gap-10 md:gap-16">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-[32px] font-normal text-gray-900 mb-3">
            Welcome
          </h1>
